...
class NativeImpl implements Native {
  ...
  Future<Int8List> fetchOdds({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_fetch_odds(port_),
      parseSuccessData: _wire2api_int_8_list,
      constMeta: kFetchOddsConstMeta,
      argValues: [],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kFetchOddsConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "fetch_odds",
        argNames: [],
      );
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_fetch_odds(
    int port_,
  ) {
    return _wire_fetch_odds(
      port_,
    );
  }

  late final _wire_fetch_oddsPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_fetch_odds');
  late final _wire_fetch_odds =
      _wire_fetch_oddsPtr.asFunction<void Function(int)>();
